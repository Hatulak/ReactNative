...
export const CELOWNIK = require('./images/celownik.png');
export const LASER = require('./images/laser.png');
export const PILL = require('./images/pill.png');
export const PILL_FIRE = require('./images/pill_fire.png');
export const STAR = require('./images/star.png');
export const STAR_BROKEN = require('./images/star_broken.png');
    ...
    return (
      <View
        ...
        <TouchableOpacity style={{height: 120}}>
          <Image
            source={CELOWNIK}
            style={{height: 50, width: 50, left: 38, top: 0}}
          />
        </TouchableOpacity>
        {this.laser()}
        <SpriteSheet
...
export {Virus, Background, Fighter, Pill, Star};
