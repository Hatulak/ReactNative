...
import { Virus, Background, Fighter, Pill, Star } from "./renderers";
import { MoveFighter, VirusSpawner, PillSpawner, StarSpawner, AccelerometerSubscribe} from "./systems";
import LifePointer from "./LifePointer";
  ...
  render() {
    ...
    return (
      <GameEngine
        ...
        systems={[MoveFighter, VirusSpawner, PillSpawner, StarSpawner]} // funkcje logiki (kontrolery) uruchamiane co 16ms (teoretycznie)
        entities={{ 
          1: { id: 1, type: 'b', position: [40,  200], renderer: <Background />}, // tlo
          2: { id: 2, type: 'f', position: [width/2-64, height-300], renderer: <Fighter />}, // fajter
          ...
          6: { id: 6, type: 'l', position: [0,0], renderer: <LifePointer />},
          7: { id: 7, type: 'p', position: [60,0], renderer: <Pill />},
          8: { id: 8, type: 's', position: [70,0], renderer: <Star />},
        }}>
